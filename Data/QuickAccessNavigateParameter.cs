...
{
    public class QuickAccessNavigateParameter : INavigateParameter
    {
        public async Task<IReadOnlyList<FolderListItem>> GetItemList()
        {
            ...
            foreach (string token in tokenList)
            {
                ...
                IStorageItem storageItem = await StorageApplicationPermissions.MostRecentlyUsedList.GetItemAsync(token);
